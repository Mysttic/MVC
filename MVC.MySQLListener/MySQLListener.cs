	...
	public async Task ChannelListener()
	{
		try
		{
			using (connection = new MySqlConnection(Settings.ConnectionString))
			{
				...
				using (MySqlCommand command = new MySqlCommand("SELECT * FROM CHANNEL", connection))
				{
	...
	public async Task CodeTemplateListener()
	{
		try
		{
			using (connection = new MySqlConnection(Settings.ConnectionString))
			{
				...
				using (MySqlCommand command = new MySqlCommand("SELECT * FROM CODE_TEMPLATE", connection))
				{
